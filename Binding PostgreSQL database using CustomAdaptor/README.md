# ASP.NET Core Grid with SQL Server Connectivity using PostgreSQL Server and CustomAdaptor

This project demonstrates how to bind data and handle CRUD operations in the **Syncfusion EJ2 Grid** using **PostgreSQL Server** and the **CustomAdaptor** in an **ASP.NET Core** application.
